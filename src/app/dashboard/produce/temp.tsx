...
export default function ProduceDashboard() {
  ...
  const [records, setRecords] = useState<HydrogenRecord[]>([
    {
      ...
      pan: "ABCDE1234F",
      gst: "29ABCDE1234F1Z5",
      hydrogen_produced: 125.5,
      electricity_consumed: 2500,
    ...
    },
    {
      ...
      pan: "ABCDE1234F",
      gst: "29ABCDE1234F1Z5",
      hydrogen_produced: 130.2,
      electricity_consumed: 2600,
    ...
    },
    {
      ...
      pan: "ABCDE1234F",
      gst: "29ABCDE1234F1Z5",
      hydrogen_produced: 118.8,
      electricity_consumed: 2400,
  ...
  const handleConfirmSubmit = async () => {
    ...
    try {
      ...
      const newRecord: HydrogenRecord = {
